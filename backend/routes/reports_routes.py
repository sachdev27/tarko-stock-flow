...
def get_top_selling_products():
    ...
    try:
        ...
        return jsonify({'error': 'Failed to get top selling products', 'details': str(e)}), 500
...
def get_location_inventory():
    ...
    try:
        ...
        return jsonify({'error': 'Failed to get location inventory', 'details': str(e)}), 500
...
def get_customer_sales():
    ...
    try:
        ...
        return jsonify({'error': 'Failed to get customer sales', 'details': str(e)}), 500
...
def get_product_inventory():
    ...
    try:
        ...
        return jsonify({'error': 'Failed to get product inventory', 'details': str(e)}), 500
...
def get_customer_regions():
    ...
    try:
        ...
        return jsonify({'error': 'Failed to get customer regions', 'details': str(e)}), 500
