...
export interface TransactionRecord {
  ...
  id: string;
  dispatch_id?: string;
  transaction_type: 'PRODUCTION' | 'SALE' | 'SCRAP' | 'CUT_ROLL' | 'ADJUSTMENT' | 'RETURN' | 'DISPATCH' | 'REVERTED' | 'TRANSFER_OUT' | 'TRANSFER_IN' | 'INTERNAL_USE' | 'CUT' | 'SPLIT_BUNDLE' | 'COMBINE_SPARES';
